# Play Store listing — TargetGoals Tasks

Copy/paste content for the Play Console store listing. Tweak to taste.
...
- **App icon (512×512):** `store-assets/play-icon-512.png` ✓ generated
- **Feature graphic (1024×500):** `store-assets/feature-graphic-1024x500.png` ✓ generated
- **Phone screenshots (required, 2–8):** capture on the device after installing the
  internal-testing build (or an emulator). Recommended shots, portrait, PNG/JPEG,
  min 320px, 9:16-ish:
  1. **Tasks** — a list with a couple tasks + an expanded subtask checklist
  2. **Daily** — habits with the streak badge and progress bar
  3. **Overview** — the streak numbers + completion heatmap
  4. **Celebration** — the hot-streak / perfect-day popup
  5. **Settings** — the "stored on this device, no account" framing + Backup
  - Optional: the home-screen **widget**.

> Tip: take screenshots on the phone (Power+Volume-Down), or in Android Studio's
> emulator. Play also lets you frame/upload them directly in the Console.
